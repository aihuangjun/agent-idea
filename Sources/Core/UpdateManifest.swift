...
/// 仓库里 `releases/latest.json`：发布脚本写，应用读。字段刻意保持最小。
public struct UpdateManifest: Codable, Equatable, Sendable {
    ...
    public init(version: String, fileName: String, sizeBytes: Int, sha256: String, publishedAt: String, notes: String? = nil) {
...
public enum UpdatePolicy {
    ...
    public static func shouldAutoCheck(lastCheck: Date?, now: Date, interval: TimeInterval = autoCheckInterval) -> Bool {
